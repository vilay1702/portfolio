...
import { EducationData, ExperienceData, ProjectData } from "../shared/types";

import portfolioData from "../shared/portfolioData.json";

// Image mapping object to connect image names to actual imports
const projectImages: { [key: string]: string } = {
  ollivanders: ollivanders.src,
  githubUsers: githubUsers.src,
  reduxCart: reduxCart.src,
  custom: custom.src,
  landingPage: landingPage.src,
};
